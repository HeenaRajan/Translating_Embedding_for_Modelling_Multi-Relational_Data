...
class TransE:
    ...
    def training(self, total_embeddings):
        ...
        optimizer = Optimizer(
            ...
            batch_size=128)
        train_summary = TrainSummary(log_dir="/home/heena/Documents/Big Data Lab/data", app_name="TrainSummary")
        ...
        trained_model.saveModel("/home/heena/Documents/Big Data Lab/data/model.bigdl", "/home/heena/Documents/Big Data Lab/data/model.bin", True)
    ...
    def testing(self):
        ...
        model = Model.loadModel("/home/heena/Documents/Big Data Lab/data/model.bigdl","/home/heena/Documents/Big Data Lab/data/model.bin")
...
if __name__ == "__main__":
    ...
    conf=SparkConf().setAppName('TransE').setMaster('local[*]')
    sc = SparkContext.getOrCreate(conf)
    sc.setLogLevel("ERROR")
    entities = pd.read_table("/home/heena/Documents/Big Data Lab/data/FB15k/entity2id.txt", header=None)
    dict_entities = dict(zip(entities[0], entities[1]+1))
    relations = pd.read_table("/home/heena/Documents/Big Data Lab/data/FB15k/relation2id.txt", header=None)
    dict_relations = dict(zip(relations[0], relations[1]+1))
    training_df = pd.read_table("/home/heena/Documents/Big Data Lab/data/FB15k/trainFB15k.txt", header=None)
    test_df=pd.read_table("/home/heena/Documents/Big Data Lab/data/FB15k/testFB15k.txt", header=None)
